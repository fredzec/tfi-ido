    ...
    return (
        <div className="main-row acea-row row-middle top-desc">
          <div className="desc-wrap">
            ...
            <div className="desc">TrustFi focuses on early crypto assets issuance, liquidity management, community
            ...
            <div className="acea-row">
              <div style={{ position: 'relative' }}>
                <div className="d-btn g bt" onClick={this.showPop.bind(this)}>Buy $TFI</div>
                {
                  showBuyPop ? (<div className="buy-pop">
                    <a href="https://pancakeswap.finance/swap?outputCurrency=0x7565ab68d3f9dadff127f864103c8c706cf28235"
                       target="_blank" className="support-item">
              ...
              <a href="https://www.certik.com/projects/trustfinetwork" target="_blank" className="d-btn b bt">Audit
                Report</a>
            </div>
          </div>
