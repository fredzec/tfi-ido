...
import ParticipateV2 from "./ParticipateV2";
...
const JoinContentV2:React.FC<props> = ({detail,version})=>{
  const {dataLoaded} = useIdoStateV2()
  return dataLoaded?(
    detail ? (
